...
const Profile = ({ user, onBack }) => {
  ...
  // Note: File upload functionality disabled for cloud-free deployment
  ...
  const saveProfile = async () => {
    ...
    try {
      // Update profile (profile picture upload disabled for cloud-free deployment)
      const updateData = {
  ...
  const cancelEdit = () => {
    ...
    // Note: File upload state removed for cloud-free deployment
    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white transition-colors duration-700">
      <div className="max-w-2xl mx-auto p-6">
        ...
        <div className="mb-8 text-center">
          ...
          {/* Note: Profile picture upload disabled for cloud-free deployment */}
          {/* Default avatar with user initials will be shown instead */}
        </div>
